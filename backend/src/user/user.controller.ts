import {Body, Controller, Delete, Get, Param, ParseIntPipe, Put, Session, UseGuards} from '@nestjs/common';
...
export class UserController {
    ...
    async deleteOwnProfile(@Session() session: SessionData): Promise<ResponseDTO> {
    ...
    @Put('update')
    @ApiResponse({ type: ResponseDTO })
    async updateUser(@Session() session: SessionData, @Body() updateUserDTO: UpdateUserDTO): Promise<ResponseDTO> {
